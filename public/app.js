...
loader.load(
  ...
  (gltf) => {
    ...
    const defaultCentersNdc = {
      pembroke: { x: 0.05, z: -0.47 },
      little_york: { x: -0.55, z: -0.18 },
      le_grande: { x: -0.22, z: -0.03 },
      penn_square: { x: 0.05, z: 0.02 },
      downtown: { x: -0.07, z: 0.18 },
      wharf: { x: -0.10, z: 0.33 },
      suplex: { x: 0.20, z: 0.24 },
      hamptons: { x: 0.52, z: 0.22 },
      soho: { x: 0.60, z: 0.44 },
      old_quarter: { x: 0.18, z: 0.52 },
      industrial_quarter: { x: 0.15, z: 0.80 },
    };
